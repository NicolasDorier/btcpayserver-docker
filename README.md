...
* `VAULTWARDEN_HOST`: If vaultwarden is activated with [opt-add-vaultwarden](docker-compose-generator/docker-fragments/opt-add-vaultwarden.yml), the hostname of your woocommerce website (eg. `vaultwarden.example.com`)
* `VAULTWARDEN_ADMIN_TOKEN`: The admin token of the password to access the admin panel. (See [documentation](docs/vaultwarden.md))
